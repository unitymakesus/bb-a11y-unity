...
class UnityModaalGalleryModule extends FLBuilderModule {
    public function __construct()
    {
        ...
        $this->add_css('unity-modaal-gallery-css', Unity\asset_path('styles/unity-modaal-gallery.css'));

        /**
         * JS
         */
        $this->add_js('modaal-js', 'https://cdnjs.cloudflare.com/ajax/libs/Modaal/0.4.4/js/modaal.min.js', ['jquery']);
        $this->add_js('unity-modaal-gallery-js', Unity\asset_path('scripts/unity-modaal-gallery.js'), ['jquery', 'modaal-js'], null, true);
    }
}
